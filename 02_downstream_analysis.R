...
# Output:   figures/01_composition.png ... figures/05_lefse.png
# =============================================================================
...
dir.create("figures", showWarnings = FALSE)   # figures are written here
...
ggsave("figures/01_composition.png", p_comp, width = 11, height = 6,
       dpi = 150, bg = "white")
...
p_alpha <- ggplot(long, aes(Group, Value, fill = Group)) +
  ...
  theme(legend.position = "none",
        strip.background = element_rect(fill = "#3C5488"),
        strip.text = element_text(colour = "white", face = "bold"))
ggsave("figures/02_alpha_diversity.png", p_alpha, width = 9, height = 6,
       dpi = 150, bg = "white")
...
ggsave("figures/03_beta_pcoa.png", p_beta, width = 9, height = 6.5,
       dpi = 150, bg = "white")
...
if (nrow(sig) > 0) {
  ...
  ggsave("figures/04_deseq2.png", p_deseq, width = 9, height = 8,
         dpi = 150, bg = "white")
...
if (nrow(mt) > 0) {
  ...
  ggsave("figures/05_lefse.png", p_lefse, width = 9, height = 8,
         dpi = 150, bg = "white")
}

cat("\nDownstream analysis complete. Figures 01-05 saved to figures/.\n")
